...
# -c                 Don't run linker
CXXFLAGS := -std=c++0x -pedantic -Wall -Wextra -Werror
...
coverage : CXXFLAGS := $(filter-out -DNDEBUG -O1 -O2 -O3, $(CXXFLAGS))
coverage : CXXFLAGS += -g -DDEBUG -O0 --coverage -fno-inline -fno-elide-constructors
